...
const group_member_controller_1 = require("./group-member.controller");
...
exports.GroupMemberModule = GroupMemberModule = __decorate([
    (0, common_1.Module)({
        imports: [
        ...
        controllers: [group_member_controller_1.GroupMemberController],
        providers: [group_member_service_1.GroupMemberService],
    })
], GroupMemberModule);
//# sourceMappingURL=group-member.module.js.map